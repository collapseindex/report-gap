...
tests/                         350 tests, including a permutation test on the analysis pipeline
...
Fourteen preregistrations, all clean against the `paper-harness` checker. 350 tests. Every raw artifact
