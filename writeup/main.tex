...
\paragraph{When this work was done.} Every confirmatory arm was run on 2026-08-01, before the sprint
window opened; the window contains this write-up, its figures and the checks that verify them. This
is completed work brought to the sprint rather than produced inside it. The repository's history is
the record we would want this checked against rather than our description of it.
...
Required by the sprint submission guidelines, and answered in the order they ask.
...
affect or experience. That valence is linearly represented and steerable is prior art, not ours.
Our subject is the instrument, and the paper's own history is the argument for treating instruments
this way: five verdicts were preregistered through this readout and three were destroyed by our own
replication at fresh option orderings.
