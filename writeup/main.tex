...
before the sprint window opened. This is completed work brought to the sprint rather than work
produced inside it, and we state it here as well as in the footnote because a reader assessing
sprint output should not have to reconstruct it from commit timestamps. What the sprint window
contains is this write-up, its figures and the checks that verify them. The preregistrations,
runners, analyzers and artifacts all carry their own dates in the repository, and the commit history
is the record we would want anyone to check this against rather than our description of it.
